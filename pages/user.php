...
<head>
    ...
    <title>Usuario - Lorem</title>
</head>
    <body>
        <?php require __DIR__ . '/../templates/header.php'; ?>
        <div class="regdis regdisesp">
            <div class="infouser">
                <main class="m-auto">
                    ...
                    <form method="POST" action="../db/upload_user.php">
                        <div class="regdis">
                            <div class="form-floating">
                                <input type="text" name="nombre" class="form-control" id="floatingInput" placeholder="" name="txtnombre" required>
                            ...
                            <div class="form-floating">
                                <input type="text" name="apell" class="form-control" id="floatingPassword" placeholder="" name="txtpasswd" required>
                                <label for="floatingInput">
                    ...
                    <form method="POST" action="../db/change_mail.php">
                        <div class="form-floating">
                            <input type="email" class="form-control" id="floatingPassword" placeholder="" name="mail" required>
                            <label for="floatingInput">
                                <?php 
                                    echo $_SESSION['mail'];
                                ?>
